...
import {
	isLoopRunning,
	isEndOfLoopingShow,
	isQuickLoopStart as checkIsQuickLoopStart,
	isQuickLoopEnd as checkIsQuickLoopEnd,
} from '@sofie-automation/corelib/src/playout/stateCacheResolver'
...
export class SegmentTimelinePartClass extends React.Component<Translated<WithTiming<IProps>>, IState> {
	...
	render(): JSX.Element | null {
		...
		const isQuickLoopStart = checkIsQuickLoopStart(this.props.part.partId, this.props.playlist)
		const isQuickLoopEnd = checkIsQuickLoopEnd(this.props.part.partId, this.props.playlist)
